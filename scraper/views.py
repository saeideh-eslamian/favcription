...
from .serializers import ChannelSerializer, GroupSerializer, KeywordSerializer, VideoSerializer
...
class GroupListCreateView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return JsonResponse({"error": "A group with this title already exists."}, status=400)
...
class GroupRetrieveUpdateDestroyView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for channel in channels:
            ...
            videos = youtube_api.get_new_videos(channel.channel_id, last_checked_date)

            # Filtering videos based on the updated video_matches_keywords
            for video in videos:
                if YouTubeAPI.video_matches_keywords(youtube_api, video, keywords):
