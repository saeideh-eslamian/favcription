...
class ChannelModelTest(TestCase):
    def setUp(self):
        self.channel = Channel.objects.create(
            title="Test Channel", channel_id="UC1234567890")
...
class GroupModelTest(TestCase):
    ...
    def setUp(self):
        self.channel1 = Channel.objects.create(
            title="Test Channel 1", channel_id="UC1234567890")
        self.channel2 = Channel.objects.create(
            title="Test Channel 2", channel_id="UC0987654321")
        ...
        self.group = Group.objects.create(
            title="Test Group", filter_from_date=timezone.now())
    ...
    def test_group_creation_with_valid_keywords(self):
        ...
        try:
            ...
            self.fail(
                "group.full_clean() raised ValidationError unexpectedly!"
                )
