...
#     def setUp(self):
#         self.channel = Channel.objects.create(name="Test Channel", youtube_id="UC1234567890")

#     def test_channel_creation(self):
#         self.assertEqual(self.channel.name, "Test Channel")
#         self.assertEqual(self.channel.youtube_id, "UC1234567890")
...
#         self.group = Group.objects.create(id=1, title="Test Group", show_from_date=timezone.now())
